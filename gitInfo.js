...
let gitHubDefinition = "Github will be the primary hosting platform that my fellow students and I will be using for version control and collaboration. Allowing us to work on problems and solutions as a team."
...
let gitPushDefinition = "The git push command is used to upload local repository content to a remote repository, in our case the remote repository would be Github."